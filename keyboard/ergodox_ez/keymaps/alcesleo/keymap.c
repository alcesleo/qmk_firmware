 ...
 * |        |  1   |  2   |  3   |  4   |  5   |  -   |           |  +   |  6   |  7   |  8   |  9   |  0   |        |
 * |--------+------+------+------+------+-------------|           |------+------+------+------+------+------+--------|
 * |  Tab   |  Q   |  W   |  E   |  R   |  T   |Media |           |Mouse |  Y   |  U   |  I   |  O   |  P   |   \    |
 * |--------+------+------+------+------+------|      |           |      |------+------+------+------+------+--------|
...
[DEFAULT] = KEYMAP(
        ...
        KC_NO,    KC_NO,    KC_NO,   KC_LEFT, KC_RGHT,
                                        ...
                                        CTL_T(KC_ESC), ALT_T(KC_TAB),
                                                             KC_LGUI,
                                      MO(SYMBOL), KC_BSPC, MO(MEDIA),

        // Right hand
        KC_PLUS,   KC_6,    KC_7,    KC_8,    KC_9,     KC_0,    KC_NO,
        TG(MOUSE), KC_Y,    KC_U,    KC_I,    KC_O,     KC_P,    KC_BSLS,
...
[MOUSE] = KEYMAP(
        ...
        // Right hand
        KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
        KC_TRNS, KC_TRNS, KC_WH_R, KC_MS_U, KC_WH_L, KC_TRNS, KC_TRNS,
